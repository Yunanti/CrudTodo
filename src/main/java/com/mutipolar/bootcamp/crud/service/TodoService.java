package com.mutipolar.bootcamp.crud.service;

import com.mutipolar.bootcamp.crud.domain.Todo;
import com.mutipolar.bootcamp.crud.repository.TodoRepository;
...
//    fungsi untuk menghapus todo
    ...
    public Optional<Todo> findByTaskCaseInsensitive(String task){
        return todoRepository.findByTaskCaseInsensitive(task);
    }
}
